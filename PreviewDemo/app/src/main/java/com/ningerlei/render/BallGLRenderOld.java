...
import com.ningerlei.shape.SphereNoTextureOld;
...
public class BallGLRenderOld implements GLSurfaceView.Renderer{
    ...
    private SphereNoTextureOld mSphere = new SphereNoTextureOld();
